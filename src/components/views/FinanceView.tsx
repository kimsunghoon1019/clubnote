  ...
  return (
    <>
      <main className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden" onClick={dismissInspected}>
        {excelInput}
        <div data-finance-console className="hidden min-h-0 flex-1 flex-col overflow-auto [scrollbar-gutter:stable] scrollbar-thin lg:flex">
          ...
          <div data-finance-table className="px-2 py-2">
            <DataTable
              columns={columns}
              rows={filtered}
              resizable
