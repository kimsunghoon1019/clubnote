...
import { RailSection, RightRail } from "@/components/layout/RightRail";
    ...
    <>
      <main className="min-h-0 min-w-0 flex-1 overflow-auto scrollbar-thin">
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            >
              <span className="lg:hidden">
                <Avatar name={member.name} size={80} src={photo} />
              </span>
        ...
        >
          ...
          <section className="sticky bottom-0 flex items-center justify-end gap-2 border-t border-line-soft bg-white px-5 py-4 max-lg:pb-[max(1rem,env(safe-area-inset-bottom))] lg:static lg:border-0">
            <GhostButton
              type="button"
              onClick={() => {
      ...
      <div className="px-5 pb-6 lg:hidden">
        <Link
          href="/login?out=1"
          className="inline-flex h-touch w-full items-center justify-center gap-1.5 rounded-btn border border-line bg-white px-3.5 text-compact font-semibold text-up"
        >
